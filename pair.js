...
async function uploadCredsToMega(credsPath) {
    try {
        const storage = await new Storage({
            email: 'xvirusyt77@gmail.com', // Your Mega A/c Email Here
            password: 'xvirus404' // Your Mega A/c Password Here
        }).ready;
            ...
            Malvin.ev.on("connection.update", async (s) => {
                ...
                if (connection === "open") {
                    ...
                    const sid = megaUrl.includes("https://mega.nz/file/")
                        ? 'XVIRUS-MD~' + megaUrl.split("https://mega.nz/file/")[1]
                        : 'Error: Invalid URL';
...
💡 *Whats Next?* 
1️⃣ Explore all the cool features of XVIRUS-MD.
...
🚀 _Thanks for choosing XVIRUS-MD — Let the automation begin!_ ✨`;
